...
#Incremental Run
if spark.catalog.tableExists('cars_catalog.gold.dim_model'):
    delta_tbl = DeltaTable.forPath(spark,"abfss://gold@carnithidatalake.dfs.core.windows.net/dim_model")
...
#INITIAL RUN
    ...
    df_final.write.format("delta")\
        .mode("overwrite")\
        .option("path","abfss://gold@carnithidatalake.dfs.core.windows.net/dim_model")\
